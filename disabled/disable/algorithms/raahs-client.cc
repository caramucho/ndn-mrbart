...
namespace ns3
{
  ...
  {
    static TypeId tid =
        TypeId("ns3::ndn::RaahsClient").SetParent<DashClientZipf>().AddConstructor<
            RaahsClient>();
    return tid;
  }
...
//      {10000 , 25000, 40000, 50000, 75000, 80000, 120000, 160000, 240000, 360000, 450000, 530000, 680000};
