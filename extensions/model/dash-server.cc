...
// Application Methods
  ...
  // void
  // DashServer::MakeSegment(uint32_t video_id, uint32_t resolution,
  ...
  void
  DashServer::OnInterest(shared_ptr<const Interest> interest)
  {
